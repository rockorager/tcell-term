...
// 	"unicode/utf8"
//
// 	"git.sr.ht/~rockorager/tcell-term/vt"
...
// 				return
// 			default:
// 				io.WriteString(t.writer, fmt.Sprintf("%s\n", seq))
// 				t.vt.Update(seq)
// 				t.SetRedraw(true)
// 			}
// 		}
...
// 		viewX := 0
// 		for viewX < w {
// 			content, style := t.vt.GetCell(viewY, viewX)
// 			t.grid.SetContent(viewX, viewY, content, nil, style)
// 			width := runewidth.RuneWidth(content)
// 			if width == 0 {
// 				width = 1
// 			}
// 			viewX += width
...
// 	}
// 	t.curVis = true
// 	t.curY, t.curX = t.vt.CursorPosition()
